<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaderMeetingMissionChangeModifyDetail.aspx.cs" Inherits="OA30.SuperviseMission.UI.MainSite.LeaderMeetingMissionChangeModifyDetail" %>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <div class="row">
                                ...
                                <span class="dib">
                                    <asp:Label ID="LabelFinishTime" runat="server" Text=""></asp:Label>
                                </span>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="detail-box">
                    <div class="detail-part detail-line">
                        ...
                        <div class="detail-col">
                            <div class="col">
                                <span>主办单位</span>
                                <span title="主办单位"><%#Eval("DeptName")%></span>
                            </div>
                        </div>
                    </div>
                    <asp:Repeater ID="Repeater15_1" runat="server" OnItemDataBound="Repeater15_1_ItemDataBound">
