<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaderMeetingMissionChangeModify.aspx.cs" Inherits="OA30.SuperviseMission.UI.MainSite.LeaderMeetingMissionChangeModify" %>
...
<body>
    <div class="main main2" url="<%=page %>">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <div class="row">
                                ...
                                <span class="dib">
                                    <asp:Label ID="LabelStartTime" runat="server" Text=""></asp:Label></span>
                            </div>
                        </li>
                        <li>
                            <div class="row">
                                <label class="dib">完成时间：</label>
                                <span class="dib">
                                    <asp:Label ID="LabelFinishTime" runat="server" Text=""></asp:Label></span>
                            </div>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="detail-col">
                                <div class="col">
                                    <span>主办单位</span><span class="tal">
                                        <input type="text" data-single="true" data-type="maindeptid" data-obj="1" data-key="<%#Eval("DeptId") %>" data-val="<%#Eval("DeptName") %>" class="form-control disabled" disabled="disabled" data-toggle="modal" data-target="#company" name="office" value="<%#Eval("DeptName") %>" />
                                    </span>
                                </div>
                            </div>
                            <div class="tar rc rr">
        ...
        <div class="card card-box reson" style="display: none;">
            <div class="card-header">
                ...
                <div class="form-group">
                    <textarea name="Reason" class="form-control th3"></textarea>
                </div>
            </div>
        </div>
        <!--end措施-->
            ...
            <div class="card card-box reson" style="display: none;">
                <div class="card-header">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="lateReason th3"></textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <ItemTemplate>
                    <div class="detail-box detail-box2">
                        <div class="detail-part pr detail-line">
                            <h3 class="c" id="mainDeptName">主办单位</h3>
                            <div class="detail-col dct">
                                <div class="col">
                                    <span>主办单位</span><span class="tal">
                                        <%#Eval("DeptName") %>
        ...
        <div class="card card-box reson" style="display: none;">
            <div class="card-header">
                ...
                <div class="form-group">
                    <textarea class="form-control th3" name="lateReason"></textarea>
                </div>
            </div>
        </div>
        <!--end措施-->
        ...
        <div class="modal-dialog" role="document" style="width: 650px;">
            <div class="modal-content">
                ...
                <div class="modal-body modal-form">
                    ...
                    <div class="form-group tac">
                        <button type="button" class="btn btn-primary-s" data-targetid="" id="btnSubmit">确定</button>
    ...
    <script>
        ...
        { %>
                    jObj = _.assign({}, item, {
                        MainDeptId: officeIds.join(';'),
                        MainDeptName: office.join(';'),
                    })
                    <% } %>
                    //子措施|措施
        ...
        { %>
            ...
            function sendAdjustmentMessage() {
                ...
                var jsonData = {
                    deptId: deptId, deptName: deptName, userId: userId, userName: userName, stepId: stepid, stepName: stepName, reason: reason, smTargetEntity: postData.SmTargetEntity, smTargetItemChangeEntitys: postData.SmTargetItemChangeEntitys
                };
        ...
        { %>
                var smTargetEntity = {};
                jsonData = {
                    deptId: deptId, deptName: deptName, userId: userId, userName: userName, stepId: stepid, stepName: stepName, reason: reason, smTargetEntity: {}, smTargetItemChangeEntitys: [postData.SmTargetEntity]
                };
                <% } %>
                ...
                $.ajax({
                    type: "POST",
                    data: JSON.stringify(jsonData),
                    url: "WebServices/SuperviseMissionWebServices.asmx/SendLeaderAdjustmentMessage",
                    contentType: 'application/json;charset=utf-8',
                    dataType: "json",
                    success: function (data) {
                        if (data.d.status == "1") {
            ...
            function sendLateMessage() {
                ...
                $.ajax({
                    type: "POST",
                    data: JSON.stringify(jsonData),
                    url: "WebServices/SuperviseMissionWebServices.asmx/SendLeaderLateMessage",
                    contentType: 'application/json;charset=utf-8',
                    dataType: "json",
                    success: function (data) {
                        if (data.d.status == "1") {
            ...
            function sendStopMessage() {
                ...
                $.ajax({
                    type: "POST",
                    data: JSON.stringify(jsonData),
                    url: "WebServices/SuperviseMissionWebServices.asmx/SendLeaderStopMessage",
                    contentType: 'application/json;charset=utf-8',
                    dataType: "json",
                    success: function (data) {
                        if (data.d.status == "1") {
            ...
            function sendBJMessage() {
                ...
                $.ajax({
                    type: "POST",
                    data: JSON.stringify(jsonData),
                    url: "WebServices/SuperviseMissionWebServices.asmx/SendLeaderBJMessage",
                    contentType: 'application/json;charset=utf-8',
                    dataType: "json",
                    success: function (data) {
                        if (data.d.status == "1") {
