<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaderMeetingMissionChangeModifyAudit.aspx.cs" Inherits="OA30.SuperviseMission.UI.MainSite.LeaderMeetingMissionChangeModifyAudit" %>
                    ...
                    <div class="detail-box">
                        <div class="detail-part detail-line">
                            ...
                            <div class="detail-col">
                                <div class="col">
                                    <span>主办单位</span>
                                    <span data-name="maindeptname" title="<%#Eval("DeptName") %>"><%#Eval("DeptName") %></span>
                                </div>
                            </div>
                        </div>
                        <asp:Repeater ID="Repeater1_1" runat="server" OnItemDataBound="Repeater1_1_ItemDataBound">
