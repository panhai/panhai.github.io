...
JBodyDialogDefaultSetting = {
    colors: [/*border*/"#aaaaaa", /*bg*/"#ffffff", /*titleBg*/"url(/images/jbody/jbdialog/winTitleBg.png) 10px -145px no-repeat #ddd", /*title*/"#145486", /*win*/"#333333", /*titleBorder*/"#aaaaaa", /*alphaBorder*/"#dddddd", /*shadow*/"#bbbbbb", /*modal*/"#bbbbbb"],
    btcolors: ["#333333", "#98b4c9", "#98b4c9", "#ffffff", "#2c73aa", "#2c73aa"],  //0,1bg,2bd:mouseout   3,4bg,5bd:mouseover
