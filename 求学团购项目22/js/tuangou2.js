...
$('.wen').mouseenter(function(){
	layer.msg('<div style="text-align:left;"><p style="font-size:14px;color:#333;font-weight:800">项目下线可能有以下几种情况:</p><p>1.项目所属门店暂停营业或已关门</p><p>2.项目到期下线</p><p>3.项目已售完</p></div>',{time:3000,shade:0})
})
